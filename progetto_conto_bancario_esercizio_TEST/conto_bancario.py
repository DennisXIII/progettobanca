#TEST DRIVEN DELEVOPMENT(TDD): Branca dello sviluppo che si occupa di programmare il test e superare il test da inserire nel programma
...
class ContoBancario:
    ...
    def prelievo(self,importo):
        ...
        if self.saldo >= importo:
            ...
            raise ValueError("SALDO INSUFFICENTE")
